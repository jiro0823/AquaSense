    ...
    <section id="contact" className="px-6 py-20 bg-gradient-to-b from-slate-50 via-sky-50 to-slate-100">
      <div className="mx-auto max-w-7xl">
        ...
        <h2 className="mb-10 text-3xl font-bold text-center text-blue-900 md:text-4xl">
          ...
          <span className="block text-cyan-500">Let's Go!</span>
        </h2>
          ...
          <div className="space-y-8">
            <div className="p-8 rounded-2xl bg-primary">
              ...
              <div className="p-6 mt-8 border border-blue-400 rounded-xl border-opacity-30 bg-slate-800 bg-opacity-40">
                <h3 className="mb-4 font-bold text-cyan-500">Social Links</h3>
                <div className="flex flex-wrap items-center gap-3">
                  <a href="https://facebook.com" target="_blank" rel="noreferrer" aria-label="Facebook" className="flex items-center justify-center w-10 h-10 transition rounded-full bg-cyan-500 hover:bg-cyan-200">
                  ...
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram" className="flex items-center justify-center w-10 h-10 transition rounded-full bg-cyan-500 hover:bg-cyan-200">
                  ...
                  <a href="https://x.com" target="_blank" rel="noreferrer" aria-label="X" className="flex items-center justify-center w-10 h-10 transition rounded-full bg-cyan-500 hover:bg-cyan-200">
                  ...
                  <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="flex items-center justify-center w-10 h-10 transition rounded-full bg-cyan-500 hover:bg-cyan-200">
